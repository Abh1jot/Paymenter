        ...
        <x-filament::section>
            ...
            <div @class(['grid grid-cols-2 gap-6' => $showPreview])>
                ...
                <div class="space-y-5">
                    ...
                    {{-- Filament form renders all fields natively --}}
                    {{ $this->form }}
                    ...
                    @else
                        <x-filament::section>
                            ...
                            <div class="flex gap-3">
                                <x-filament::button wire:click="sendCampaign" wire:loading.attr="disabled" color="warning" icon="ri-send-plane-line">
                                ...
                                <x-filament::button wire:click="cancelSend" color="gray">Cancel</x-filament::button>
                            </div>
                        </x-filament::section>
                    @endif
                </div>
                            ...
                            @foreach ($this->campaigns as $campaign)
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                                        {{ $campaign->recipient_type === 'active' ? 'Active customers' : 'All users' }}
                                    </td>
                                    <td class="px-6 py-4">
                                        @if ($campaign->total_count > 0)
                                            <div class="flex items-center gap-2">
                                                <div class="h-1.5 bg-gray-200 dark:bg-white/10 rounded-full overflow-hidden w-20">
                                    ...
                                    <td class="px-6 py-4">
                                        <x-filament::badge :color="match($campaign->status) { 'done' => 'success', 'sending' => 'warning', 'failed' => 'danger', default => 'gray' }">
