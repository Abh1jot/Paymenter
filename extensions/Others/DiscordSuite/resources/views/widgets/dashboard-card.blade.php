<div class="bg-background-secondary border border-neutral rounded-xl p-6 shadow-sm">
    ...
    @if($isLinked && $account)
        ...
        <div class="flex items-center justify-between gap-3 pt-2">
            <a href="{{ route('discord-suite.account.settings') }}" wire:navigate class="text-xs text-primary hover:underline font-medium flex items-center gap-1">
    ...
    @else
        <div class="space-y-4">
            ...
            <a href="{{ route('discord-suite.oauth.redirect') }}" target="_self" data-navigate-ignore rel="external" class="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 transition shadow-sm">
