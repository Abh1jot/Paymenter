<div class="container mt-14">
    ...
    @if($isLinked && $account)
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-background-secondary border border-neutral rounded-xl p-6 flex flex-col justify-between">
                ...
                <div class="pt-4 border-t border-neutral flex gap-2">
            ...
            <div class="bg-background-secondary border border-neutral rounded-xl p-6 lg:col-span-2">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="font-bold text-base text-lg">Community Servers</h2>
                            ...
                            <div class="bg-background border border-neutral p-4 rounded-lg flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-emerald-500 font-medium">Auto-Join Enabled</span>
                                    </div>
                                </div>
                                @if($guild->invite_url)
                ...
                @else
                    <p class="text-sm text-base/60">No specific public servers have been configured yet. Roles are mapped to provider servers.</p>
                @endif
    ...
    @else
        ...
        <div class="bg-background-secondary border border-neutral rounded-xl p-8 text-center max-w-xl mx-auto shadow-sm my-10">
            ...
            <a href="{{ route('discord-suite.oauth.redirect') }}" class="inline-flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-2.5 px-6 rounded-lg transition shadow-md">
