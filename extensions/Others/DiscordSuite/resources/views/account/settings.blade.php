<div class="container mt-14">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-background-secondary border border-neutral rounded-xl p-6 flex flex-col justify-between">
                ...
                <div class="pt-4 border-t border-neutral flex flex-col gap-2">
                    ...
                    <a href="{{ route('discord-suite.oauth.redirect') }}" target="_self" data-navigate-ignore rel="external" class="w-full bg-[#5865F2]/10 hover:bg-[#5865F2]/20 text-[#5865F2] border border-[#5865F2]/20 text-xs font-semibold py-2 px-3 rounded-lg transition text-center flex items-center justify-center gap-1.5">
    ...
    @else
        ...
        <div class="bg-background-secondary border border-neutral rounded-xl p-8 text-center max-w-xl mx-auto shadow-sm my-10">
            ...
            <a href="{{ route('discord-suite.oauth.redirect') }}" target="_self" data-navigate-ignore rel="external" class="inline-flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold py-3 px-8 rounded-xl transition shadow-md hover:shadow-lg">
